...
export const Route = createFileRoute("/checkout-schutz")({
  ...
  head: () => ({
    meta: [
      { title: "SCHUTZ — Pagamento Seguro (3 Etapas)" },
      {
        name: "description",
        content: "Checkout seguro em 3 etapas da Sandália Translúcida Schutz.",
      },
    ],
  }),
  component: SchutzCheckoutThreeSteps,
});

function SchutzCheckoutThreeSteps() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] font-sans text-gray-900 antialiased selection:bg-black selection:text-white">
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-40 shadow-xs">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5 sm:py-4 flex items-center justify-between">
          <Link to="/translucida-schutz" className="text-2xl sm:text-3xl font-black tracking-tighter text-black">
            SCHUTZ
          </Link>
          <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold tracking-wider text-gray-500 uppercase">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        {currentStep === 4 ? (
          ...
          <div className="max-w-md mx-auto bg-white p-8 rounded-2xl border border-gray-200 shadow-xl text-center space-y-5 animate-in zoom-in-95 duration-300">
            ...
            <Link
              to="/translucida-schutz"
              className="inline-block w-full bg-black hover:bg-gray-900 text-white font-bold py-3.5 rounded-xl text-xs uppercase tracking-widest transition-all shadow"
            >
              Voltar à Loja
            </Link>
          </div>
              ...
              {currentStep === 1 && (
                <form onSubmit={handleNextStep1} className="space-y-6 animate-in fade-in duration-300">
                  ...
                  <section className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
                    <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                      <h3 className="font-black text-xs uppercase tracking-widest text-gray-900 flex items-center gap-2">
                        ...
                        1. Personalize sua Sandália
                      </h3>
                      <span className="text-[10px] text-gray-400 uppercase font-bold">Edição Exclusiva</span>
                    </div>
                  ...
                  <section className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
                    ...
                    <div className="space-y-3.5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-gray-300 bg-gray-50 px-3.5 py-3 text-xs text-gray-900 outline-none focus:bg-white focus:border-black focus:ring-1 focus:ring-black"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-gray-300 bg-gray-50 px-3.5 py-3 text-xs text-gray-900 outline-none focus:bg-white focus:border-black focus:ring-1 focus:ring-black font-mono"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-black hover:bg-gray-900 active:scale-[0.99] text-white font-black py-4 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2"
                    >
                  ...
                  <section className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-6 gap-3.5">
                      ...
                      <div className="sm:col-span-1">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-gray-300 bg-gray-50 px-3 py-3 text-xs text-center font-bold text-gray-900 outline-none focus:bg-white focus:border-black focus:ring-1 focus:ring-black"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3 pt-2">
                      <button
                        type="button"
                        onClick={() => setCurrentStep(1)}
                        className="px-5 py-4 border border-gray-300 hover:border-black rounded-xl text-xs font-bold uppercase tracking-wider transition-all"
                      >
                        Voltar
                      </button>
                      <button
                        type="submit"
                        className="flex-1 bg-black hover:bg-gray-900 active:scale-[0.99] text-white font-black py-4 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2"
                      >
                      ...
                      <section className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-200 shadow-xs space-y-4">
                          ...
                          <div className="pt-3 border-t border-gray-100 space-y-3.5 animate-in fade-in duration-200">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-xl border border-gray-300 bg-gray-50 px-3.5 py-3 text-xs text-gray-900 outline-none focus:bg-white focus:border-black focus:ring-1 focus:ring-black uppercase"
                              />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full rounded-xl border border-gray-300 bg-gray-50 px-3.5 py-3 text-xs text-gray-900 outline-none focus:bg-white focus:border-black focus:ring-1 focus:ring-black font-mono text-center"
                                />
                              </div>
                              <div>
                                <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-600 mb-1">
                        ...
                        <div className="flex gap-3 pt-2">
                          ...
                          <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 bg-black hover:bg-gray-900 active:scale-[0.99] disabled:opacity-50 text-white font-black py-4 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2"
                          >
                            {loading ? (
                              <>
